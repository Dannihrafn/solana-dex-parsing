...
pub fn new_get_account_keys(transaction: &SubscribeUpdateTransaction) -> Vec<String> {
...
pub fn get_filtered_instructions_new(transaction: &SubscribeUpdateTransaction, account_keys: &Vec<String>, program_id: &str) -> Vec<StructuredInstruction> {
    ...
    let structured_instructions = structure_all_instructions_new(&transaction);
    let filtered_instructions = filter_instructions(&structured_instructions, account_keys, program_id);
    filtered_instructions
}

pub fn structure_all_instructions_new(transaction: &SubscribeUpdateTransaction) -> Vec<StructuredInstruction> {
